...
export default function Detailtugasdone2() {
  return (
    <View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 25}}>
            <View>
                <Text style={{ fontSize: 24, color: '#2261BF', fontWeight: 'bold', textAlign: 'left'}}>Kontrol Akses</Text>
            ...
            <View style={{width: 112, height: 61, borderColor: '#2261BF', borderWidth:1, borderRadius: 20, padding: 10, marginLeft: 75}}>
                <Text style={{ fontSize: 24, color: '#2261BF', textAlign: 'center', fontWeight: 'bold', marginTop: 5}}>11:00</Text>
            </View>
        </View>
        <ScrollView>
        ...
        <View style={{ width: 335, height: 182, borderColor: 'rgba(34, 97, 191, 0.2)', borderWidth: 1, borderRadius: 20, padding: 10, marginTop: 20, marginLeft: 25 }}>
            ...
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 7, marginLeft: 20 }}>1. Awasi dan kontrol titik-titik masuk kantor</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>2. Pastikan pengunjung merupakan orang</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>yang memiliki izin</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>3. Setiap pengunjung yang memiliki izin</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>akan diberikan QR untuk discan oleh </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>petugas </Text>
        </View>
