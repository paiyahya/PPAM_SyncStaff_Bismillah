...
export default function Detailtugas2() {
  return (
    <View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 25}}>
            <View>
                <Text style={{ fontSize: 24, color: '#2261BF', fontWeight: 'bold', textAlign: 'left'}}>Kontrol Parkir</Text>
            ...
            <View style={{width: 112, height: 61, borderColor: '#2261BF', borderWidth:1, borderRadius: 20, padding: 10, marginLeft: 75}}>
                <Text style={{ fontSize: 24, color: '#2261BF', textAlign: 'center', fontWeight: 'bold', marginTop: 5}}>16:00</Text>
            </View>
        </View>
        <ScrollView>
        <View style={{ width: 335, height: 87, borderColor: 'rgba(34, 97, 191, 0.2)', borderWidth: 1, borderRadius: 20, padding: 10, marginTop: 30, marginLeft: 25 }}>
            ...
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>Area Parkir </Text>
        </View>
        <View style={{ width: 335, height: 182, borderColor: 'rgba(34, 97, 191, 0.2)', borderWidth: 1, borderRadius: 20, padding: 10, marginTop: 20, marginLeft: 25 }}>
            ...
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 7, marginLeft: 20 }}>1. Mengawasi kendaraan yang parkir di area</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>parkir </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>2. Awasi tindakan orang-orang yang men- </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>curigakan dan orang-orang yang keluar </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>masuk area parkir </Text>
        </View>
