  ...
  return (
    <View>
        ...
        <View style={{ flexDirection: 'row', marginTop: 15}}>
            <Link style={{marginLeft: 60, marginTop: 20}} href="/homepage">
                <Text style={{ fontSize: 14, color: '#2261BF', fontWeight: 'bold', textAlign: 'left', marginTop: 20, marginLeft: 60 }}>Terbaru</Text>
            </Link>
            <Text style={{ fontSize: 14, color: '#2261BF', fontWeight: 'bold', textAlign: 'left', marginTop: 20, marginLeft: 140 }}>Teratas</Text>
        </View>
