...
export default function Detailtugasdone0() {
  return (
    <View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 25}}>
            <View>
                <Text style={{ fontSize: 24, color: '#2261BF', fontWeight: 'bold', textAlign: 'left'}}>Briefing Pagi</Text>
            ...
            <View style={{width: 112, height: 61, borderColor: '#2261BF', borderWidth:1, borderRadius: 20, padding: 10, marginLeft: 75}}>
                <Text style={{ fontSize: 24, color: '#2261BF', textAlign: 'center', fontWeight: 'bold', marginTop: 5}}>08:00</Text>
            </View>
        </View>
        <ScrollView>
        ...
        <View style={{ width: 335, height: 182, borderColor: 'rgba(34, 97, 191, 0.2)', borderWidth: 1, borderRadius: 20, padding: 10, marginTop: 20, marginLeft: 25 }}>
            ...
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 7, marginLeft: 20 }}>1. Menghadiri briefing pagi oleh supervisor</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>2. Melakukan scan QR untuk presensi </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>3. Mengambil peralatan yang diperlukan</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>(walkie talkie, kunci) dan difoto </Text>
        </View>
