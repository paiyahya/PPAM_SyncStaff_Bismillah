...
export default function Detailtugas0() {
  return (
    <View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 25}}>
            <View>
                <Text style={{ fontSize: 24, color: '#2261BF', fontWeight: 'bold', textAlign: 'left'}}>Judul Tugas</Text>
                <Text style={{ fontSize: 16, color: '#000000', textAlign: 'left', marginTop: 5}}>Hari, DD MM YYYY</Text>
            </View>
            <View style={{width: 112, height: 61, borderColor: '#2261BF', borderWidth:1, borderRadius: 20, padding: 10, marginLeft: 75}}>
                <Text style={{ fontSize: 24, color: '#2261BF', textAlign: 'center', fontWeight: 'bold', marginTop: 5}}>HH:MM</Text>
            </View>
        </View>
        <ScrollView>
        <View style={{ width: 335, height: 87, borderColor: 'rgba(34, 97, 191, 0.2)', borderWidth: 1, borderRadius: 20, padding: 10, marginTop: 30, marginLeft: 25 }}>
            ...
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>Lorem Ipsum Dolor Dit Amet, Consectetur Adipiscing Elit. Sed Nisl Metus, Bibenduma </Text>
        </View>
        <View style={{ width: 335, height: 182, borderColor: 'rgba(34, 97, 191, 0.2)', borderWidth: 1, borderRadius: 20, padding: 10, marginTop: 20, marginLeft: 25 }}>
            ...
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 7, marginLeft: 20 }}>1. Lorem Ipsum Dolor Dit Amet, Consectetur</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>Adipiscing Elit. Sed Nisl Metus, Bibenduma </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>2. Lorem Ipsum Dolor Dit Amet, Consectetur</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>Adipiscing Elit. Sed Nisl Metus, Bibenduma </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>3. Lorem Ipsum Dolor Dit Amet, Consectetur</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>Adipiscing Elit. Sed Nisl Metus, Bibenduma </Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginTop: 5, marginLeft: 20 }}>4. Lorem Ipsum Dolor Dit Amet, Consectetur</Text>
            <Text style={{ fontSize: 12, textAlign: 'left', marginLeft: 33 }}>Adipiscing Elit. Sed Nisl Metus, Bibenduma </Text>
        </View>
